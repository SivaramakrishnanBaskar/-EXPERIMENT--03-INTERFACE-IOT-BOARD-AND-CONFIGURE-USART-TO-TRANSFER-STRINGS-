...
int main(void)
{
  ...
  while (1)
  {
	  printf("Sivaramakrishnan.B 212222110044 \n");
	  HAL_Delay(500);
...
![IOT LAB03 oUT](https://github.com/SivaramakrishnanBaskar/-EXPERIMENT--03-INTERFACE-IOT-BOARD-AND-CONFIGURE-USART-TO-TRANSFER-STRINGS-/assets/119476322/735ce654-3faa-4882-9f47-e5408b412fc0)
